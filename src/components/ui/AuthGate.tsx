      ...
      <div className="fixed inset-0 flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4">
        <div className="w-full max-w-xs">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-pomor-500/10 mb-4">
          ...
          >
            <div>
              ...
              <input
                ...
                autoFocus
                placeholder="••••"
                className="w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/60 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-pomor-500/40 text-sm transition-all"
              />
              {error && (
            ...
            <button
              ...
              className="w-full py-2.5 text-sm font-semibold text-white bg-pomor-500 hover:bg-pomor-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-colors"
            >
